...
circle_speed = min(screen_size) / 100  # Absolute speed of the circle is 1/100th of the screen size's smallest dimension
...
while running:
    ...
    old_circle_posistion = circle_posistion
    circle_posistion += circle_velocity
