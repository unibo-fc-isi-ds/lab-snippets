...
class ServerStub(Server):
    def __init__(self, port):
        ...
        self.__authentication = InMemoryAuthenticationService(self.__user_db)
    ...
    def __handle_request(self, request):
        try:
            ...
            elif hasattr(self.__authentication, request.name):
                method = getattr(self.__authentication, request.name)
